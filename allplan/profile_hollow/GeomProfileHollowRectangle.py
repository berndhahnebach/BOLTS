...
class GeomProfileHollowRectangle():
    def __init__(self, params):
        ...
        # build geometry
        self.Shape = make_hollow_rectangle_solid(h, b, t, length)


def make_hollow_rectangle_solid(h, b, t, length):
    ...
    outer = Geo.BRep3D.CreateCuboid(origin_o, h, b, length)
    inner = Geo.BRep3D.CreateCuboid(origin_i, (h-2*t), (b-2*t), length)
